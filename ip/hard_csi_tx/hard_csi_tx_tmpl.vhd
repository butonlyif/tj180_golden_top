...
port (
    ...
    TxUlpsEsc : out std_logic_vector(1 downto 0);
    TxSkewCalHS : out std_logic_vector(1 downto 0);
    TxUlpsExit : out std_logic_vector(1 downto 0);
    TxRequestEsc : out std_logic_vector(1 downto 0);
    TxStopStateD : in std_logic_vector(1 downto 0);
    TxStopStateC : in std_logic;
    TxUlpsActiveNot : in std_logic_vector(1 downto 0);
    TxReadyHS : in std_logic_vector(1 downto 0);
    TxRequestHS : out std_logic_vector(1 downto 0);
...
end component hard_csi_tx;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_hard_csi_tx : hard_csi_tx
port map (
